...
$header_template = [
	['key'=>'Users.name','label'=>'企業名'],
	['key'=>'establish','label'=>'設立'],
	['key'=>'capital','label'=>'資本金'],
	['key'=>'employee','label'=>'従業員数'],
];
...
<table class="table table-bordered table-striped">
	<thead>
		<tr>
			<th><?= $this->Paginator->sort('Users.name','企業名')?></th>
			<th><?= $this->Paginator->sort('establish','設立')?></th>
			<th><?= $this->Paginator->sort('capital','資本金')?></th>
			<th>従業員数</th>
