...
<ul class="nav nav-pills nav-stacked">
    ...
    <li role="presentation"><?= $this->Html->link('関連性',['controller'=>'contacts','action'=>'index'])?></li>
    ...
    <li role="presentation"><?= $this->Html->link('debug ダミーデータ生成　コメント',['controller'=>'debug','action'=>'dummyComments'])?></li>
