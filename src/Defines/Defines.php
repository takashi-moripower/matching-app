...
class Defines {
	...
	const NOTICE_FLAG_ENGINEER = 1;
	const NOTICE_FLAG_ENTERPRISE_PREMIUM = 0x10;
	const NOTICE_FLAG_ENTERPRISE_FREE = 0x20;
	const NOTICE_FLAG_ENTERPRISE_BOTH = 0x30;
	const NOTICE_FLAG_ALL = self::NOTICE_FLAG_ENGINEER | self::NOTICE_FLAG_ENTERPRISE_BOTH;

	const NOTICE_FLAGS = [
		self::NOTICE_FLAG_ALL => 'すべて',
		self::NOTICE_FLAG_ENGINEER => '技術者',
		self::NOTICE_FLAG_ENTERPRISE_BOTH => '企業',
		self::NOTICE_FLAG_ENTERPRISE_PREMIUM => '企業（プレミア）',
		self::NOTICE_FLAG_ENTERPRISE_FREE => '企業(フリー）',
	];

	const GROUP_NOTICE_FLAG = [
		self::GROUP_ENGINEER => self::NOTICE_FLAG_ENGINEER,
		self::GROUP_ENTERPRISE_PREMIUM => self::NOTICE_FLAG_ENTERPRISE_PREMIUM,
		self::GROUP_ENTERPRISE_FREE => self::NOTICE_FLAG_ENTERPRISE_FREE,
	];
